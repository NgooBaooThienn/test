...
if(in_array($_SERVER['HTTP_HOST'], $domain_black)) {
    echo 'Bạn đang vi phạm bản quyền của DAILYSIEURE.VN, vui lòng kích hoạt bản quyền trước khi dùng.<br><a href="https://dailysieure.vn">Mua giấy phép kích hoạt tại đây</a>';
}